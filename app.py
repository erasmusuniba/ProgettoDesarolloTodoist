...
#Questa estensione rileva le modifiche apportate ai nostri modelli (nuovi modelli, nuovi campi,...) e genera script con i quali possiamo facilmente effettuare aggiornamenti del database. 
